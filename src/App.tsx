...
import { Search, Copy, Check, Eye, EyeOff, FileText, LayoutGrid, Book } from 'lucide-react';
import { fetchData } from './services/dataFetcher';
// NOTA: Si ya cambiaste el nombre a NormativaViewer o WikiViewer, ajusta el import aquí.
// Yo mantengo los nombres originales para que no te de error al pegar.
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#020617] to-[#1e3a8a] flex flex-col items-center p-2 sm:p-4 font-sans text-white">
      ...
      {/* CAMBIO 1: Header Responsive (flex-wrap permite que bajen si no caben) */}
        ...
        {view === 'SEARCH' && (
          <>
            <div className="p-4 sm:p-8 pb-4">
              ...
              {/* CAMBIO 2: Grilla para las categorías (2 columnas en móvil) */}
              {mode === 'CODIGOS' && (
